            ...
            <form action="{{ route('users.store') }}" method="POST" class="d-flex flex-column card p-4" style="gap:12px"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nip') is-invalid @enderror" id="nip"
                        placeholder="nip" name="nip" value="{{ old('nip') }}" required>
                    @error('nip')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('jabatan') is-invalid @enderror" id="jabatan"
                        placeholder="jabatan" name="jabatan" value="{{ old('jabatan') }}" required>
                    @error('jabatan')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control @error('password_input') is-invalid @enderror"
                        id="password_input" name="password_input" value="">
                ...
                <div class="col-6 form-group">
                    <label for="ttd_upload">Upload TTD<span class="text-danger">*</span></label>
