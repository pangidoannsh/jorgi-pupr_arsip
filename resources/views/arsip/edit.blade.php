...
@section('content')
    <div class="row justify-content-center">
        <div class="col-6">
            <form action="{{ route('arsip.update', $model) }}" method="POST" class="d-flex flex-column card p-4"
                    ...
                    <select class="form-select @error('kode_klasifikasi') is-invalid @enderror" name="kode_klasifikasi"
                        ...
                        @foreach ($klasifikasi as $item)
                            <option value="{{ $item->kode_klasifikasi }}"
                                {{ old('kode_klasifikasi', $model->kode_klasifikasi) == $item->kode_klasifikasi ? 'selected' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nomor_berkas') is-invalid @enderror" id="nomor_berkas"
                        placeholder="nomor_berkas" name="nomor_berkas"
                        value="{{ old('nomor_berkas', $model->nomor_berkas) }}" required>
                    @error('nomor_berkas')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nomor_arsip') is-invalid @enderror" id="nomor_arsip"
                        placeholder="nomor_arsip" name="nomor_arsip" value="{{ old('nomor_arsip', $model->nomor_arsip) }}"
                        required>
                    @error('nomor_arsip')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('uraian_informasi') is-invalid @enderror"
                        ...
                        value="{{ old('uraian_informasi', $model->uraian_informasi) }}" required>
                ...
                <div class="row align-items-start">
                    <div class="col-6 form-group">
                        ...
                        <input type="date" class="form-control @error('tanggal_mulai') is-invalid @enderror"
                            ...
                            value="{{ old('tanggal_mulai', $model->tanggal_mulai) }}" required>
                        @error('tanggal_mulai')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-6 form-group">
                        ...
                        <input type="date" class="form-control @error('tanggal_selesai') is-invalid @enderror"
                            ...
                            value="{{ old('tanggal_selesai', $model->tanggal_selesai) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('jumlah') is-invalid @enderror" id="jumlah"
                        placeholder="jumlah" name="jumlah" value="{{ old('jumlah', $model->jumlah) }}" required>
                    @error('jumlah')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('tingkat_perkembangan') is-invalid @enderror"
                        ...
                        value="{{ old('tingkat_perkembangan', $model->tingkat_perkembangan) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('keterangan_nomor_box') is-invalid @enderror"
                        ...
                        value="{{ old('keterangan_nomor_box', $model->keterangan_nomor_box) }}" required>
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-6 form-group">
                        ...
                        <input type="text" class="form-control @error('url_file') is-invalid @enderror"
                            id="url_file" placeholder="url_file" name="url_file"
                            value="{{ old('url_file', $model->url_file) }}">
                        @error('url_file')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
